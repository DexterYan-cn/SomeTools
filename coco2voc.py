# COCO格式转化为voc的xml格式数据
# 在最后的参数配置写入json目录指向和xml保存目录指向即可
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="convert coco .json annotation to voc .xml annotation")
    # parser.add_argument('--json_path', type=str,
    #                     help='path to json file.', default=r"F:/AITODsYolo/annotations/val.json")
    parser.add_argument('--json_path', type=str,
                        help='path to json file.', default=r"F:/AUDD/annotations/instances_train.json")
    parser.add_argument('--output', type=str,
                        help='path to output xml files.', default=r"F:/AUDD/xml/train")
