...
注：为修改类别信息中间有空格的问题，将24行，61、62行，74、89行进行了修改
此为最终版实现yolo2coco格式的代码
"""
...
# parser.add_argument('--root_dir', default='/home/joe/YanPeng/002_MyData/URPC_2020/cocoFormat/train',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
# parser.add_argument('--root_dir', default='../003_TrainData/Visdrone2019Yolo/2cocotest',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
# parser.add_argument('--root_dir', default='../003_TrainData/TinyPersonYolo/2cocotest',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
parser.add_argument('--root_dir', default=r'F:/CompressedVersionYolo/2cocotrain',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
...
# yolo_format_classes_path='../002_MyData/coco128/coco.names'
